...
import '../../../domain/usecases/authentication/authenticate_with_google_usecase_imp.dart';
...
class LoginIoC extends Bindings {
  ...
  void dependencies() {
    ...
    Get.lazyPut<AuthenticateWithGoogleUseCase>(() => AuthenticateWithGoogleUseCaseImp(Get.find()));
